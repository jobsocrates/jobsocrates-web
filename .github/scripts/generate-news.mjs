...
위 기준으로 걸러낸 뒤, 취준생에게 가장 유익한 기사 2개만 선택하세요.
...
- 친근하고 담백한 말투
- 쉼표(,) 남발 금지. 명사·항목 나열 외에는 쓰지 마라.

출력 형식 (반드시 아래 구조를 정확히 지키세요):

TITLE: [주제 한 줄] [기사1 핵심 키워드, 기사2 핵심 키워드]
형식 예시: AI가 바꾸는 일과 삶의 방식 [AI에이전트, 배민 AI 예측 도입]
규칙: 주제는 15자 이내 취준생이 공감할 표현, 키워드는 각 기사에서 가장 눈길 끄는 핵심어 2~4단어씩
