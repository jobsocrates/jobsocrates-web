...
async function generateJasoserTip(role) {
  ...
  const dualNote = isDual
    ? `\n이 직무는 산업군에 따라 성격이 다릅니다 (예: ${role}).
BEFORE/질문/AFTER 전반에 걸쳐 두 산업 맥락(일반 제조 vs 화학 계열)의 차이가 자연스럽게 드러나도록 작성하세요.
예를 들어 제조 품질은 치수·외관 불량 중심, 화학 품질은 성분 분석·배치 기록 중심임을 본문에 녹이세요.`
    : "";
